 ...
 * ```
 */
export const strSplit = ( /*#__PURE__*/_unwrapFunction("split", StrProto));
/**
 ...
 * ```
 */
export const strSymSplit = ( /*#__PURE__*/_unwrapFunctionWithPoly("split", StrProto, !hasSymbol() ? polyStrSymSplit : null));
