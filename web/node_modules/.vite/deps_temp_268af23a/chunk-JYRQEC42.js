// ../node_modules/@nevware21/ts-utils/dist/es5/mod/internal/constants.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/helpers/safe.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/helpers/safe_get.js
function safeGet(cb, defValue) {
  var result = safe(cb);
  return result.e ? defValue : result.v;
}

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/helpers/base.js
var _primitiveTypes;
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/object/get_own_prop_desc.js
var objGetOwnPropertyDescriptor = ObjClass.getOwnPropertyDescriptor;

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/object/has_own_prop.js
function objHasOwnProperty(obj, prop) {
  return !!obj && ObjProto.hasOwnProperty[CALL](obj, prop);
}

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/object/has_own.js
var objHasOwn = ObjClass["hasOwn"] || polyObjHasOwn;
function polyObjHasOwn(obj, prop) {
  return objHasOwnProperty(obj, prop) || !!objGetOwnPropertyDescriptor(obj, prop);
}

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/object/for_each_key.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/internal/map.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/helpers/throw.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/polyfills/object.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/object/object.js
...
var objValues = ObjClass.values || polyObjValues;

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/helpers/enum.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/symbol/well_known.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/string/as_string.js
var asString = StrCls;

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/internal/global.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/helpers/diagnostics.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/internal/unwrapFunction.js
var _unwrapFunction = (
  /*__PURE__*/
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/math/min_max.js
var mathMin = MathCls.min;
var mathMax = MathCls.max;

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/string/slice.js
var strSlice = _unwrapFunction("slice", StrProto);

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/string/substring.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/polyfills/symbol.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/object/define.js
var propMap = {
  e: "enumerable",
  c: "configurable",
  v: "value",
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/helpers/lazy.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/helpers/safe_lazy.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/helpers/cache.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/helpers/environment.js
var WINDOW = "window";
var _cachedGlobal;
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/symbol/symbol.js
var _symbol;
var _symbolFor;
var _symbolKeyFor;
function _initSymbol() {
  if (!_symbol || !_symbol.b) {
    ...
    _symbolFor = safeGetLazy(function() {
      return _symbol.v ? _symbol.v["for"] : UNDEF_VALUE;
    }, UNDEF_VALUE);
    _symbolKeyFor = safeGetLazy(function() {
      return _symbol.v ? _symbol.v["keyFor"] : UNDEF_VALUE;
    }, UNDEF_VALUE);
  }
}
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/iterator/iterator.js
function isIterator(value) {
  return !!value && isFunction(value.next);
}
function isIterable(value) {
  return !isStrictNullOrUndefined(value) && isFunction(value[getKnownSymbol(
    3
    /* WellKnownSymbols.iterator */
  )]);
}

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/iterator/forOf.js
var _iterSymbol;
function iterForOf(iter, callbackfn, thisArg) {
  if (iter) {
    if (!isIterator(iter)) {
      !_iterSymbol && (_iterSymbol = createCachedValue(getKnownSymbol(
        3
        /* WellKnownSymbols.iterator */
      )));
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/funcs/funcs.js
function fnApply(fn, thisArg, argArray) {
  return fn.apply(thisArg, argArray);
}

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/array/append.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/array/every.js
var arrEvery = _unwrapFunction("every", ArrProto);
var arrFilter = _unwrapFunction("filter", ArrProto);

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/array/forEach.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/array/indexOf.js
var arrIndexOf = _unwrapFunction("indexOf", ArrProto);
var arrLastIndexOf = _unwrapFunction("lastIndexOf", ArrProto);

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/array/map.js
var arrMap = _unwrapFunction("map", ArrProto);

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/array/slice.js
function arrSlice(theArray, start, end) {
  return (theArray && theArray["slice"] || ArrSlice).apply(theArray, ArrSlice[CALL](arguments, 1));
}

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/polyfills/array.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/array/find.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/array/from.js
var arrFrom = ArrCls.from || polyArrFrom;

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/array/includes.js
var arrIncludes = _unwrapFunctionWithPoly("includes", ArrProto, polyArrIncludes);

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/array/reduce.js
var arrReduce = _unwrapFunction("reduce", ArrProto);

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/array/some.js
var arrSome = _unwrapFunction("some", ArrProto);

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/object/create.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/object/set_proto.js
var _isProtoArray;
function objSetPrototypeOf(obj, proto) {
  var fn = ObjClass["setPrototypeOf"] || // tslint:disable-next-line: only-arrow-functions
  function(d, b) {
    !_isProtoArray && (_isProtoArray = getLazy(function() {
      var _a6;
      return (_a6 = {}, _a6[__PROTO__] = [], _a6) instanceof Array;
    }));
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/helpers/customError.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/helpers/date.js
function utcNow() {
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/polyfills/trim.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/string/trim.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/string/upper_lower.js
var strUpper = _unwrapFunction("toUpperCase", StrProto);
var strLower = _unwrapFunction("toLowerCase", StrProto);

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/math/floor.js
var mathFloor = MathCls.floor;
var mathCeil = MathCls.ceil;

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/math/trunc.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/math/to_int.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/string/repeat.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/string/pad.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/object/is_plain_object.js
var _fnToString;
var _objCtrFnString;
var _gblWindow;
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/object/copy.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/helpers/extend.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/helpers/length.js
var getLength = _unwrapProp(LENGTH);

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/helpers/perf.js
var _perf;
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/polyfills/split.js
function polyStrSymSplit(value, splitter, limit) {
  var splitFn = splitter && splitter[getKnownSymbol(
    9
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/string/split.js
var strSplit = _unwrapFunction("split", StrProto);
var strSymSplit = _unwrapFunctionWithPoly("split", StrProto, !hasSymbol() ? polyStrSymSplit : null);

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/helpers/get_set_value.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/string/ends_with.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/string/index_of.js
var strIndexOf = _unwrapFunction("indexOf", StrProto);
var strLastIndexOf = _unwrapFunction("lastIndexOf", StrProto);

// ../node_modules/@nevware21/ts-utils/dist/es5/mod/string/includes.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/string/starts_with.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/timer/handler.js
var REF = "ref";
var UNREF = "unref";
var HAS_REF = "hasRef";
var ENABLED = "enabled";
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/timer/timeout.js
...
// ../node_modules/@nevware21/ts-utils/dist/es5/mod/timer/idle.js
var _hasIdleCallback;
var _defaultIdleTimeout = 100;
var _maxExecutionTime = 50;
function hasIdleCallback() {
  !_hasIdleCallback && (_hasIdleCallback = safeGetLazy(function() {
    return isDefined(requestIdleCallback);
  }, false));
...
function _createPromise(newPromise, processor, executor) {
    ...
    return function(theValue) {
      if (_state === allowState) {
        if (newState === 2 && isPromiseLike(theValue)) {
          _state = 1;
          theValue.then(_createSettleIfFn(
            2,
            1
            /* ePromiseState.Resolving */
          ), _createSettleIfFn(
            3,
            1
            /* ePromiseState.Resolving */
  ...
  if (_promiseDebugEnabled) {
    _addDebugState(_thePromise, _strState, function() {
  ...
  (function _initialize() {
    ...
    var _rejectFn = _createSettleIfFn(
      3,
      0
      /* ePromiseState.Pending */
    );
    try {
      executor.call(_thePromise, _createSettleIfFn(
        2,
        0
        /* ePromiseState.Pending */
      ), _rejectFn);
...
// ../node_modules/@nevware21/ts-async/dist-es5/promise/syncPromise.js
...
// ../node_modules/@nevware21/ts-async/dist-es5/promise/idlePromise.js
...
function createPromise(executor, timeout) {
  !_promiseCreator && (_promiseCreator = getLazy(function() {
...
function normalizeJsName2(name) {
  var value = name;
...
function createUniqueNamespace(name, includeVersion) {
  ...
  return normalizeJsName2(name + _dataUid++ + (includeVersion ? "." + version : STR_EMPTY) + instanceName);
}
    ...
    get: function(target, name2, defValue, addDefault) {
      ...
      if (!theCache) {
        if (addDefault) {
          ...
          theCache[normalizeJsName2(name2)] = defValue;
        }
        return defValue;
      }
      return theCache[normalizeJsName2(name2)];
    },
          ...
          if (_logger && _logger.queue) {
            ...
            arrForEach(queue, function(logMessage) {
              ...
              var item = (_a6 = {}, _a6[
                ...
                _DYN_MESSAGE_ID
                /* @min:%2emessageId */
              ], _a6.iKey = _instrumentationKey, _a6[
                _DYN_TIME
                /* @min:time */
...
export {
  ...
  doAwaitResponse,
  createPromise,
  normalizeJsName2 as normalizeJsName,
  toISOString,
  getExceptionName,
  setValue,
  getSetValue,
...
//# sourceMappingURL=chunk-JYRQEC42.js.map
